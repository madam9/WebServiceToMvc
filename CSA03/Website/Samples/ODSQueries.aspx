<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" 
    CodeFile="ODSQueries.aspx.cs" Inherits="Samples_ODSQueries" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <link href="../Content/GridViewOverrides.css" rel="stylesheet" />
    <div class="page-header">
        <h1>Product By Category - ODS</h1>
    </div>
    <div class="row col-md-12">
        <div class="alert alert-warning">
            <blockquote style="font-style:italic">
                This illustrates multiple record display query using ODS for the processing.
            </blockquote>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <asp:GridView ID="ProductList" runat="server" AutoGenerateColumns="False"
                ...
                PageSize="5" DataSourceID="ProductListODS" AllowPaging="True">
                <Columns>
    ...
    <asp:ObjectDataSource ID="CategoryListODS" runat="server" 
        ...
        TypeName="CSA03.NorthwindSystem.BLL.CategoryController"></asp:ObjectDataSource>
    <asp:ObjectDataSource ID="ProductListODS" runat="server"
        OldValuesParameterFormatString="original_{0}"
        SelectMethod="Products_GetByCategories"
        TypeName="CSA03.NorthwindSystem.BLL.ProductController">
        <SelectParameters>
